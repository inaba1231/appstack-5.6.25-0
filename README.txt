...
Bitnami LAPP stack is an easy to install and easy to use open source Web 
...
painless way to deploy LAPP in any Linux environment.

You can learn more about Bitnami stacks at https://bitnami.com/stacks/


Bitnami LAPP is also available as a Virtual Machine Image or as a Cloud Image.
...
The Bitnami LAPP stack is distributed as a binary executable installer.
...
bitnami-lappstack-5.6.25-0-linux-installer.run on Linux or
bitnami-lappstack-5.6.25-0-linux-x64-installer.run on Linux 64 bit.

You can install Bitnami LAPP stack in graphical, text and unattended modes. 
By default the graphical mode will be used.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-lappstack-5.6.25-0-linux.run
...
a regular user, or /opt/lappstack-5.6.25-0, if you are running the 
...
The default listening port for Apache is 8080 and for PostgreSQL is 5432. If those 
...
The rest of this guide assumes that you installed Bitnami LAPP stack in 
/home/user/lappstack-5.6.25-0 and that you use port 8080 for Apache and 5432 for PostgreSQL.

6. STARTING AND STOPPING BITNAMI LAPP STACK
...
Bitnami LAPP stack. Take a look at the docs/README.txt file to know
...
"Cannot open bitnami-lappstack-5.6.25-0-linux.run: No application suitable for 
