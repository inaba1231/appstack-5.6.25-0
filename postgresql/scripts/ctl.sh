...
HOSTNAME=`hostname`
POSTGRESQL_PIDFILE=/home/inaba/appstack-5.6.25-0/postgresql/data/postmaster.pid

POSTGRESQL_START="/home/inaba/appstack-5.6.25-0/postgresql/bin/pg_ctl start -w -D /home/inaba/appstack-5.6.25-0/postgresql/data"
POSTGRESQL_STOP="/home/inaba/appstack-5.6.25-0/postgresql/bin/pg_ctl stop -D /home/inaba/appstack-5.6.25-0/postgresql/data"
...
start_postgresql() {
    ...
    if [ $ERROR -eq 0 ]; then
	echo "$0 $ARG: postgresql  started at port 5432"
	sleep 2
    else
